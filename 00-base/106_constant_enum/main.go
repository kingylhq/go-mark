...
const LSY string = "LSY"

const MARK = "MARK"

const TYPE1, TYPE2, TYPE3 = "SUCCESS", "FAIL", "CANCEL"

const TYPE4, TYPE5, TYPE6 string = "SUCCESS", "FAIL", "CANCEL"
...
//注：Go 中，常量只能使用基本数据类型，即数字、字符串和布尔类型。不能使用复杂的数据结构，比如切片、数组、map、
//指针和结构体等。如果使用了非基本数据类型，会在编译期报错。
