...
func transactions() {
	...
	//在上个章节 我们学习了如何在给定区块编号的情况下读取块及其所有数据。 我们可以通过调用 Transactions 方法来读取块中的事务，
	//该方法返回一个 Transaction 类型的列表。 然后，重复遍历集合并获取有关事务的任何信息就变得简单了。
	...
	// 可以调用 TransactionCount 来了解块中有多少个事务。
